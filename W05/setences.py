...
def get_noun(quantity):
    ...
    """
        if quantity == 1:
            words = [ "bird", "boy", "car", "cat", "child", "dog", "girl", "man", "woman"]
        else:
            words = ["birds", "boys", "cars", "cats", "children", "dogs", "girls", "men", "women"]
...
def get_prepositional_phrase(quantity):
    ...
    return prep + ' ' + determiner + ' ' + noun

def main():
    
    print(get_prepositional_phrase(quantity))
    print(get_prepositional_phrase(quantity))
    print(get_prepositional_phrase(quantity))
    print(get_prepositional_phrase(quantity))
    print(get_prepositional_phrase(quantity))
